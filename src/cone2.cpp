...
void Cone2::setSections ( double distance )
{
...
//   theSolver.setConvergence( &Cone2::myConvergence );
...
void Cone2::computeNodalPower ( Particle* particle )
{
...
void Cone2::outputTable()
{
    std::ofstream out ( "top_table.txt" );
}


void Cone2::outputPowerFile ( int particles )
{
...
void Cone2::outputPowerDensityFile()
{
